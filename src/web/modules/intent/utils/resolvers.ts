...
import { resolveInteropAddress } from '@ambire-common/services/interop'
...
export const createResolvers = (context: ResolverContext): Resolver[] => [
  {
    ...
    resolve: async (address: string) => {
      try {
        ...
        console.warn('Failed to resolve interop address', error)
        // Avoid throwing an toast here, this should detect if was a network error
